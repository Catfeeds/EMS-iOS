...
//        [_leftImageView sd_setImageWithURL:[NSURL URLWithString:self.imageURLStrings[leftIndex]] placeholderImage:[UIImage imageNamed:@"placerholder"]];
//        [_middleImageView sd_setImageWithURL:[NSURL URLWithString:self.imageURLStrings[curIndex]] placeholderImage:[UIImage imageNamed:@"placerholder"]];
//        [_rightImageView sd_setImageWithURL:[NSURL URLWithString:self.imageURLStrings[rightIndex]] placeholderImage:[UIImage imageNamed:@"placerholder"]];
